...
class SingleP_Conformer(nn.Module):
    def __init__(self, conformer_class, d_model, d_ffn, n_head, enc_layers, dec_layers, norm_type='max', l=10, decoder_type='crossattn', encoder_type='conformer', label_type='p'):
